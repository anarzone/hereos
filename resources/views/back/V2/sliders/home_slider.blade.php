                            ...
                            <div class="col-md-12">
                                <div class="large_center_slider_wrapper">
                                    <div class="home_slider_header_tab jelly_loading_pro">
                                        <div class="item">
                                            <div class="banner-carousel-item"> <span class="image_grid_header_absolute" style="background-image: url({{asset('V2/front/img/1920x982.png')}})"></span>
                                        ...
                                        <div class="item">
                                            <div class="banner-carousel-item"> <span class="image_grid_header_absolute" style="background-image: url({{asset()}}'img/1920x982.png')"></span>
                                                <a href="#" class="link_grid_header_absolute"></a>
                                                <div class="banner-container">
                                                    <div class="container">
                                                        <div class="row">
                                        ...
                                        <div class="item">
                                            <div class="banner-carousel-item"> <span class="image_grid_header_absolute" style="background-image: url('img/1920x982.png')"></span>
                                                <a href="#" class="link_grid_header_absolute"></a>
                                                <div class="banner-container">
                                                    <div class="container">
                                                        <div class="row">
                                    ...
                                    <div class="jlslide_tab_nav_container">
                                        <div class="jlslide_tab_nav_row">
                                            <div class="home_slider_header_tab_nav news_tiker_loading_pro">
                                                <div class="item">
                                                    <div class="banner-carousel-item"> <span class="image_small_nav" style="background-image: url('img/120x120.png')"></span>
                                                        <h5>

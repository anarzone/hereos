    ...
    <div class="navbar-wrapper">
        <div class="navbar-logo">
            <a href="{{route('dashboard')}}">
                <img class="img-fluid" src="{{asset('V2/admin/png/logo.png')}}" alt="Theme-Logo" />
            </a>
    ...
    <i class="feather icon-search input-group-text"></i>
            ...
            <ul class="nav-right">
                <li class="header-notification">
                    <div class="dropdown-primary dropdown">
                        ...
                        <ul class="show-notification notification-view dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                            ...
                            <li>
                                <div class="media">
                                    <img class="img-radius" src="{{asset('V2/admin/jpg/avatar-4.jpg')}}" alt="Generic placeholder image">
                ...
                <li class="user-profile header-notification">
                    <div class="dropdown-primary dropdown">
                        <div class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{asset('V2/admin/jpg/avatar-4.jpg')}}" class="img-radius" alt="User-Profile-Image">
                            <span>John Doe</span>

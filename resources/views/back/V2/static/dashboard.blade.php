...
@endsection
@section('unique-js')
    <script src="{{asset('V2/admin/js/jquery.flot.js')}}" type="text/javascript"></script>
    <script src="{{asset('V2/admin/js/jquery.flot.categories.js')}}" type="text/javascript"></script>
    <script src="{{asset('V2/admin/js/curvedlines.js')}}" type="text/javascript"></script>
    <script src="{{asset('V2/admin/js/jquery.flot.tooltip.min.js')}}" type="text/javascript"></script>

    <script src="{{asset('V2/admin/js/chartist.js')}}" type="text/javascript"></script>

    <script src="{{asset('V2/admin/js/amcharts.js')}}" type="text/javascript"></script>
    <script src="{{asset('V2/admin/js/serial.js')}}" type="text/javascript"></script>
    <script src="{{asset('V2/admin/js/light.js')}}" type="text/javascript"></script>
    <script type="text/javascript" src="{{asset('V2/admin/js/custom-dashboard.min.js')}}"></script>
@endsection

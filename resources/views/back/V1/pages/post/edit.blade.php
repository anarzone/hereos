                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="title" type="text" id="title" value="{{$post->title}}" class="form-control @error('title') is-invalid @enderror" {{ old('title') }} placeholder="write cool title">
                                            @error('title')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="slug" type="text" id="slug" value="{{$post->slug}}" class="form-control @error('slug') is-invalid @enderror" {{ old('slug') }} placeholder="post-slug">
                                            @error('slug')
                                                <small class="alert alert-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="seo_title" id="seo_title" value="{{$post->seo_title}}" class="form-control @error('seo_title') is-invalid @enderror" {{ old('seo_title') }} >
                                    </div>
                                    @error('seo_title')
                                        <small class="alert alert-danger">{{ $message }}</small>
                                    @enderror
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="seo_description" type="text" id="seo_description" value="{{$post->seo_description}}" class="form-control @error('seo_description') is-invalid @enderror" {{ old('seo_description') }} >
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="seo_keywords" type="text" id="tags" value="{{$post->seo_keywords}}" class="form-control @error('seo_keywords') is-invalid @enderror" {{ old('seo_keywords') }}>
                                    </div>
                                    @error('seo_keywords')
                                        <small class="alert alert-danger">{{ $message }}</small>
                                    @enderror
                ...
                <div class="row">
                    <div class="col-2">
                        <label class="checkbox-inline float-right">
                            ...
                            <input name="status" id="toggle-event" type="checkbox" @if( $post->status == 1) checked @endif data-toggle="toggle" data-style="ios" value="1"> Publish
                        </label>
                    </div>
                    <!-- /.col -->
                    <div class="col-10">
